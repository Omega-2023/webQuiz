...
const initialState = {
  questions: [
    ...
    {
      question: "In rehabilitation engineering, what is a common application of assistive devices?",
      choices: [
    ...
    {
      question: "Which field of biomedical engineering involves the study of the mechanical aspects of living organisms?",
      choices: [
        "Biomedical Ethics",
        "Biomechanics",
        "Regulatory Affairs",
    ...
    {
      question: "What is a common application of medical robotics in healthcare?",
      choices: [
    ...
    {
      question: "What does the term 'biological signal processing' refer to in biomedical engineering?",
      choices: [
    ...
    {
      question: "What is the purpose of regulatory affairs in biomedical engineering?",
      choices: [
